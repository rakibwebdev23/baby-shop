        ...
        <div className="group relative border border-gray-200 bg-white hover:shadow-md p-2">
            <div className="aspect-w-1 aspect-h-1 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-pink-300/40 opacity-0 group-hover:opacity-100">
                    <button className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#FF8080] hover:bg-[#f45e5e] px-4 py-2 text-sm font-medium text-white rounded">                         Add to Cart
                    </button>
                </div>
            </div>
            <div className="p-3">
